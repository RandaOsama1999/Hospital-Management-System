 ...
 * @author Randa
 */
public class GuiAddFinancials extends JFrame{
    ...
    public GuiAddFinancials() {
        ...
        try {
            ...
            Logger.getLogger(GuiAddFinancials.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private class dosave implements ActionListener
    {
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            if (ae.getSource().equals(add)){
                ...
                f.setFirstName(FNametxt.getText());
                f.setMiddleName(MNametxt.getText());
                f.setLastName(LNametxt.getText());
                f.setEmail(Emailtxt.getText());
                f.setBirthDate(BDatetxt.getText());
                f.setCity(Citytxt.getText());
                f.setAddress(Addresstxt.getText());
                f.setPhoneNumber(PNotxt.getText());
                f.setTelephoneNumber(HNotxt.getText());
                f.setGender(genders.getSelectedItem().toString());
                f.setStatus(Status.getSelectedItem().toString());
                
                //doctors.add(d);
                f.Add();    
                JOptionPane.showMessageDialog(null, "Financial has be added Successfully!");
