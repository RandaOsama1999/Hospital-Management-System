 ...
 * @author Randa
 */
public class GuiAddHR extends JFrame{
    ...
    public GuiAddHR() {
        ...
        try {
            ...
            Logger.getLogger(GuiAddHR.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private class dosave implements ActionListener
    {
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            if (ae.getSource().equals(add)){
                ...
                h.setID(IDtxt.getText());
                h.setFirstName(FNametxt.getText());
                h.setMiddleName(MNametxt.getText());
                h.setLastName(LNametxt.getText());
                h.setEmail(Emailtxt.getText());
                h.setBirthDate(BDatetxt.getText());
                h.setCity(Citytxt.getText());
                h.setAddress(Addresstxt.getText());
                h.setPhoneNumber(PNotxt.getText());
                h.setTelephoneNumber(HNotxt.getText());
                h.setGender(genders.getSelectedItem().toString());
                h.setStatus(Status.getSelectedItem().toString());
                
                //doctors.add(d);
                h.Add();    
                JOptionPane.showMessageDialog(null, "HR has be added Successfully!");
