 ...
 * @author Randa
 */
public class GuiAddReceptionists extends JFrame{
    ...
    public GuiAddReceptionists() {
        ...
        try {
            ...
            Logger.getLogger(GuiAddReceptionists.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private class dosave implements ActionListener
    {
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            if (ae.getSource().equals(add)){
                ...
                r.setFirstName(FNametxt.getText());
                r.setMiddleName(MNametxt.getText());
                r.setLastName(LNametxt.getText());
                r.setEmail(Emailtxt.getText());
                r.setBirthDate(BDatetxt.getText());
                r.setCity(Citytxt.getText());
                r.setAddress(Addresstxt.getText());
                r.setPhoneNumber(PNotxt.getText());
                r.setTelephoneNumber(HNotxt.getText());
                r.setGender(genders.getSelectedItem().toString());
                r.setStatus(Status.getSelectedItem().toString());
                
                //doctors.add(d);
                r.Add();    
                JOptionPane.showMessageDialog(null, "Receptiontist has be added Successfully!");
