 ...
 * @author Randa
 */
public class GuiSearchFinancials extends JFrame{
    ...
    GuiSearchFinancials()
    {
        ...
        try {
            ...
            Logger.getLogger(GuiSearchFinancials.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private class dosave implements ActionListener
    {
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            {      
                    try {
                    int idx=f.Search(IDtxt.getText());
                    f.Remove(idx);
                } catch (FileNotFoundException ex) {
                    Logger.getLogger(GuiSearchFinancials.class.getName()).log(Level.SEVERE, null, ex);
                }           
                ...
                try {
                    int idx=f.Search(IDtxt.getText());
                    GuiEditFinancial a=new GuiEditFinancial(idx);
                    a.setVisible(true);
