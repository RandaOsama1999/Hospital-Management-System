 ...
 * @author Randa
 */
public class GuiSearchNurse extends JFrame{
    ...
    GuiSearchNurse()
    {
        ...
        try {
            ...
            Logger.getLogger(GuiSearchNurse.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private class dosave implements ActionListener
    {
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            {      
                    try {
                    int idx=n.Search(IDtxt.getText());
                    n.Remove(idx);
                } catch (FileNotFoundException ex) {
                    Logger.getLogger(GuiSearchNurse.class.getName()).log(Level.SEVERE, null, ex);
                }           
                ...
                try {
                    int idx=n.Search(IDtxt.getText());
                    GuiEditNurse a=new GuiEditNurse(idx);
                    a.setVisible(true);
