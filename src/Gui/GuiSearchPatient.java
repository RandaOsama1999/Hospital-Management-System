 ...
 * @author Randa
 */
public class GuiSearchPatient extends JFrame{
    ...
    GuiSearchPatient() throws ParseException
    {
        this.p = new Patient();
    ...
    private class dosave implements ActionListener
    {
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            {
                try {
                    p.Search(IDtxt.getText());
                } catch (FileNotFoundException ex) {
                    Logger.getLogger(GuiSearchPatient.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            {      
                try {
                    int idx=p.Search(IDtxt.getText());
                    p.Remove(idx);
                } catch (FileNotFoundException ex) {
                    Logger.getLogger(GuiSearchPatient.class.getName()).log(Level.SEVERE, null, ex);
                }
                ...
                try {
                    int idx=p.Search(IDtxt.getText());
                    GuiEditPatient a=new GuiEditPatient(idx);
                    a.setVisible(true);
