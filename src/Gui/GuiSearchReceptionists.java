 ...
 * @author Randa
 */
public class GuiSearchReceptionists extends JFrame{
    ...
    private class dosave implements ActionListener
    {
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            {      
                    try {
                    int idx=r.Search(IDtxt.getText());
                    r.Remove(idx);
                } catch (FileNotFoundException ex) {
                    Logger.getLogger(GuiSearchReceptionists.class.getName()).log(Level.SEVERE, null, ex);
                }           
                ...
                try {
                    int idx=r.Search(IDtxt.getText());
                    GuiEditReceptionist a=new GuiEditReceptionist(idx);
                    a.setVisible(true);
